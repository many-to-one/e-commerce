...
const Products: React.FC = () => {
  ...
  const renderSwiperSection = (title: string, data: ProductType[], className?: string) => (
  ...
  return (
    <>
      {isLoading ? (
        <div className="products-page">
          {/* {renderSwiperSection('Polecane produkty', recommended, 'section-recommended')}
          {renderSwiperSection('Promocje', discounts, 'section-discounts')}
          {renderSwiperSection('Nowości', news, 'section-news')} */}
          ...
          <div className="flexRowCenter gap-15 mt-20  footer-cont">
            <button
              onClick={() => {
                if (prevPage) {
                  fetchProducts(prevPage);
