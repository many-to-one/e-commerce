...
class Product(models.Model):
    ...
    new_hurt_price = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, null=True, blank=True, verbose_name='Nowa cena hurtowa brutto')
    ...
    allegro_started_at = models.DateTimeField(null=True, blank=True, verbose_name="data wystawienia na allegro")
    allegro_ended_at = models.DateTimeField(null=True, blank=True, verbose_name="data zakończenia na allegro")
...
class InvoiceCorrection(models.Model):
    invoice_number = models.CharField("Numer korekty", max_length=100, unique=True, editable=True)
